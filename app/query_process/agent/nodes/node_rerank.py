...
def step_1_merge_docs(state):
    ...
    for i, doc in enumerate(rrf_docs):
        ...
        title = entity.get("title") or entity.get("item_name") or entity.get("item_name") or ""

        # ===== 听书领域元数据（用于回答中的来源引用）=====
        item_name = entity.get("item_name") or entity.get("item_name") or ""
        author_name = entity.get("author_name") or ""
